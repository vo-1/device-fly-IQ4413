...
cd ../..
cd frameworks/av
git apply -v ../../device/micromax/AQ5001/patches/frameworks_av/frameworks_av.patch
cd ../..
cd frameworks/base
...
cd ../../..
cd packages/hardware/libhardware
...
git apply -v ../../../device/micromax/AQ5001/patches/packages_services_Telephony/services_Telephony.patch
cd ../../..
cd system/core
